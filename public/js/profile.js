...
$.get("/api/all/" + $("#userNameProfile").text(), function(data) {
    if (data.length !== 0) {
...
$.get("/api/dep/" + $("#userNameProfile").text(), function(depo){
    $.get("/api/with/" + $("#userNameProfile").text(), function(withd){
